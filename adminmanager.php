         ...
         <div class="card shadow">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Gestionnaire d'admins</h3>
                </div>
                <div class="col text-right">
                  <a href="#" data-toggle="modal" data-target="#newadmin" class="btn btn-sm btn-primary">Ajouter</a>
                </div>
              </div>
            </div>
            <?php
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                     <a href="#" data-toggle="modal" data-target="#adminsetting<?php echo $adm['aid']; ?>">
                     <i class="ni ni-settings text-info mr-2"></i></a>                     
                     <a href="?adid=<?php echo $adm['aid']; ?>" onclick="return confirm('Voulez-vous supprimer cet admin ?');"><i class="ni ni-button-power text-warning"></i></a>
